...
- «Радар» потенциальных партнёров: ручной ввод и CSV/XLSX, SSRF-safe исследование сайта через HTML/sitemap/RSS, ЛПР и публичные контакты с источниками, оценка трафика через Similarweb, объяснимый Partner Score, готовое первое касание и решения accept/defer/reject/merge;
